...
public class Kalastus extends Sivupohja {
	...
	public Kalastus(PageParameters sivunParametrit) {
		...
		// TODO Auto-generated constructor stub
		   ...
		   */
		   ...
		   final IModel kalastusModelli = new LoadableDetachableModel() {
	       
			private static final long serialVersionUID = 1L;

			protected Object load() {
	             Collection<Tuote> kalastus =
	       	     palvelu.haetuoteRyhmanMukaan("kalastus");
	           	 return kalastus;
	       ...
	       ListView kalastus2	 = new ListView("kalastus2", kalastusModelli) {
	          /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
